...
import type { MarkerStyle, MapColorPalette } from '../types';
...
function PreviewIllustrated() {
  return (
    <span className="inline-flex items-end gap-1">
      <img src={ILLUSTRATED_ICONS.cage} alt="" className="w-[16px] h-[20px]" />
      <img src={ILLUSTRATED_ICONS.free} alt="" className="w-[16px] h-[20px]" />
    </span>
  );
}

function PreviewEgg({ colors }: { colors: MapColorPalette }) {
...
function PreviewCircle({ colors }: { colors: MapColorPalette }) {
...
function PreviewIllustratedMixed() {
  return (
    <span className="inline-flex items-end gap-1">
      <img src={ILLUSTRATED_ICONS.cageInverted} alt="" className="w-[16px] h-[20px]" />
      <img src={ILLUSTRATED_ICONS.freeNoBorder} alt="" className="w-[16px] h-[20px]" />
    ...
    <div className="absolute top-3 right-3 z-[2]">
      ...
      {open && (
        <div className="absolute top-10 right-0 mt-1 w-[210px] bg-white/95 backdrop-blur-md rounded-xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          {/* ═══ SECTION: Marker size (range slider) ══════════════════════ */}
          ...
          {/* ═══ SECTION: Marker opacity (range slider) ═══════════════════ */}
